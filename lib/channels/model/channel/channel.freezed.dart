...
abstract class $ChannelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int position, String resolution, String name});
}
...
class _$ChannelImpl implements _Channel {
  ...
  @override
  String toString() {
    return 'Channel(id: $id, position: $position, resolution: $resolution, name: $name)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, position, resolution, name);
...
abstract class _Channel implements Channel {
  const factory _Channel(
      ...
      required final String name}) = _$ChannelImpl;
